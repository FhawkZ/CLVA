...
def setup_config(args: argparse.ArgumentParser) -> MlSpacesExpConfig:
    ...
    if args.place_receptacle_types:
        datagen_cfg.task_sampler_config.place_receptacle_types = args.place_receptacle_types.split(",")
...
if __name__ == "__main__":
    ...
    args.add_argument(
        "--place_receptacle_types",
        type=str,
        default=None,
        help="comma separated list of place receptacle types",
    )
    args.add_argument(
